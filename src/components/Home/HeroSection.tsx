...
export default function HeroSection() {
  ...
  return (
    <section className="h-[calc(100vh-6rem)] xl:h-[calc(100vh-9rem)] flex items-center relative">
      <div className="absolute -z-10 bottom-0 left-1/2 -translate-x-1/2 w-screen flex justify-center overflow-y-hidden">
        <Background />
      </div>
