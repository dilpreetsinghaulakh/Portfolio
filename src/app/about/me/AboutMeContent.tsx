...
export default function AboutMeContent() {
  return (
    <div className="flex flex-col gap-12 mt-4 text-lg text-secondary-100">
      <p>
        I am currently pursuing a Bachelor's degree in Technology with a passion
        for coding and continuous learning. My journey in programming began as a
        self-taught developer, where I have independently acquired skills in web
        development and iOS development. My curiosity drives me to explore new
        technologies and enhance my expertise in creating dynamic and responsive
        web applications.
      </p>
      <p>
